...
// 	switch (expr->kind) {
// 	case AST_ASSIGN:
// 		if (expr->binop == TOKEN_KIND_ASSIGN) {
...
// 			switch (expr->binop) {
// 			case TOKEN_KIND_ADD_ASSIGN: v = add_values(v, v2); break;
// 			case TOKEN_KIND_SUBTRACT_ASSIGN: v = subtract_values(v, v2); break;
// 			case TOKEN_KIND_MULTIPLY_ASSIGN: v = multiply_values(v, v2); break;
// 			case TOKEN_KIND_DIVIDE_ASSIGN: v = divide_values(v, v2); break;
// 			case TOKEN_KIND_MODULO_ASSIGN: v = modulo_values(v, v2); break;
...
// 		v2 = run_expression(expr->rhs, e);
// 		switch (expr->binop) {
// 		case TOKEN_KIND_ADD: return add_values(v, v2);
// 		case TOKEN_KIND_SUBTRACT: return subtract_values(v, v2);
// 		case TOKEN_KIND_MULTIPLY: return multiply_values(v, v2);
// 		case TOKEN_KIND_DIVIDE: return divide_values(v, v2);
// 		case TOKEN_KIND_MODULO: return modulo_values(v, v2);
// 		case TOKEN_KIND_LESS_THAN: return new_boolean_value(compare_values(v, v2) < 0);
// 		case TOKEN_KIND_GREATER_THAN: return new_boolean_value(compare_values(v, v2) > 0);
// 		case TOKEN_KIND_LESS_THAN_OR_EQUAL: return new_boolean_value(compare_values(v, v2) <= 0);
// 		case TOKEN_KIND_GREATER_THAN_OR_EQUAL: return new_boolean_value(compare_values(v, v2) >= 0);
// 		case TOKEN_KIND_EQUAL: return new_boolean_value(equate_values(v, v2));
// 		case TOKEN_KIND_NOT_EQUAL: return new_boolean_value(!equate_values(v, v2));
